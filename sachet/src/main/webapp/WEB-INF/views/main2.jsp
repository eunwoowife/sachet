...
<div class="navWrap">
    ...
    <ul class="gnbList">
            ...
            <li><a href="/kr/sub.html?pid=13">참가안내</a></li>
            <li><a href="/kr/sub.html?pid=14">온라인참가신청</a></li>
    ...
    <div class="subMenu"><h3><span>행사안내</span></h3>
        ...
        <aside class="sideNav">
            ...
            <ul class="quickMenu">
                <li class="quick07"><a href="/kr/sub.html?pid=174">BIAF<br>이모티콘</a></li>
                <li class="quick04"><a href="/kr/sub.html?pid=19">오시는길</a></li>
                <li class="quick06"><a href="/kr/sub.html?pid=51">굿즈</a></li>
            </ul>
            <a href="#homePage" class="btnTop"><img src="/kr/img/main_2021/btn_top.png" alt="TOP"></a>
        </aside>
        
        
       <div id="fullpage" class="fullpage-wrapper" style="height: 100%; position: relative; transform: translate3d(0px, 0px, 0px);">
            <section id="section0" class="section color2022 fp-section active fp-table fp-completely" data-anchor="homePage" style="height: 694px; padding-top: 88px; background-color: rgb(255, 255, 255);">
            
            <div class="fp-tableCell" style="height: 694px;">
				 
				<div class="mainVisual mainTop">
                    <a href="/kr/sub.html?pid=20&amp;idx=215&amp;m_idx=2020&amp;formtype=view" style="background-image:url(${pageContext.request.contextPath}/resources/images/spellonyou.jpg);">
                        <p class="visualImg">
                            <picture>
                               <source media="(max-width: 960px)" srcset="/img/main_2022/img_visual2022_mo.jpg" />
                             <img src="${pageContext.request.contextPath}/resources/images/spellonyou.jpg" alt="">
				 ...
				 <div class="mainSection mainTop" style="background-image:url(${pageContext.request.contextPath}/resources/images/003.jpg);">
                        ...
                        <div class="mainFor">
                            <div class="slider">
								...
								<div class="item">
                                    ...
                                    <p class="midiaTit"><span>[다슈X차은우] DASHUXCHA EUN-WOO 아쿠아 다이브</span></p>
                                </div>
								<div class="item">
                                    <div class="video">
                    ...
                    <button type="button" class="prev" data-visual="mainVisual">이전</button>
                    <button type="button" class="next" data-visual="mainSection">다음</button>
                </div>
            ...
            <section id="section1" class="section" style="background-image:url(${pageContext.request.contextPath}/resources/images/003.jpg);">
                <div class="programWrap">
                    <div class="sectionTit">
                        ...
                        <h2><strong>경쟁작</strong> 프로그램안내</h2>
                    </div>
                            ...
                            <li class="first">
                                <a href="/kr/sub.html?pid=174">
                                    <picture>
                                        ...
                                        <img src="/img/main_2022/img_program_bn01.jpg" alt="부스배치안">
                                    </picture>
                                </a>
                            </li>
                            <li class="second">
                                ...
                                <a href="/kr/sub.html?pid=185">
                                    <picture>
                                        ...
                                        <img src="/img/main_2022/img_program_bn02.jpg" alt="티켓예매 티켓 예매 방법 및 혜택 등 안내">
                                    </picture>
                                </a>
                            </li>
                        </ul>
							...
							<li>
                                <a href="/kr/sub.html?pid=51">
                                    <picture>
                                        ...
                                        <img src="/img/main_2022/img_program_bn03.jpg" alt="비아프 2022 굿즈. 아기자기하고 실용적인 굿즈">
                                    </picture>
                                </a>
                            </li>
                         </ul>
                    ...
                    <div class="latestWrap clearfix">
                       <ul class="tabBtn">
                        ...
                        <div id="tab1" class="left tabCon active">
                            <h3>공지사항</h3>
							<div class="latestTop">
<span class="date">2022-10<em>25</em></span>
...
BIAF2022 단편애니메이션제작지원 예선심사 결과안내</a>
				...
				<a href="/kr/sub.html?pid=52" class="btnMore">더보기</a>                        </div>
                        <div id="tab2" class="right tabCon">
                            <h3>보도자료</h3>
							<div class="latestTop">
<span class="date">2022-12<em>12</em></span>
            ...
            <div class="footerWrap">
                <p class="fLogo"><a href="/kr/">
                        <picture>
                            ...
                            <img src="/kr/img/common/logo_footer_2023.png" alt="2023 BIAF 2023 BUCHEON INTERNATIONAL ANIMATION FESTIVAL">
                        </picture>
                    </a></p>
                <div class="ftInfo">
                    <ul class="footerLink">
                    ...
                    <address>
                        <ul>
                            ...
                            <li>단체장: 서채환 </li>
                            <li>고유번호: 130-82-11347</li>
                            <li>통신판매신고번호: 제 2013-경기부천-1186호</li>
