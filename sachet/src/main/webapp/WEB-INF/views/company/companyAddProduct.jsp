        ...
        <div class="layout-page">
          ...
          >
           ...
           <div class="addProductOuter">
           		...
           		<form action="insertProduct.co" method="post" enctype="multipart/form-data">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="10"  style="resize: none; width:700px;" name="productDetail"></textarea>
           					
           					
      					  <label for="html5-number-input" class="col-md-2 col-form-label">상품재고</label>
                        <div class="col-md-10">
                          <input class="form-control" type="number" id="html5-number-input" style="width:700px;" min="1" name="productStock"/>
                        </div>
                        
                          <label for="html5-number-input" class="col-md-2 col-form-label">상품가격(￦)</label>
                        <div class="col-md-10">
                          <input class="form-control" type="number" id="html5-number-input" style="width:700px;" min="1000" name="productPrice"/>
                        </div>
                        ...
                        <table>
                        	  <tr>
					                <td align="center">
					                	...
					                	<input type="file" id="file1" onchange="loadImg(this,1);" name="upfile" required>
