...
<link href="${pageContext.request.contextPath}/resources/css/demo.css" />
    ...
    <!-- Vendors CSS -->
<link href="${pageContext.request.contextPath}/resources/css/perfect-scrollbar.css" />

    <!-- Page CSS -->

    <!-- Helpers -->
<link href="${pageContext.request.contextPath}/resources/css/helpers.js"></script>
